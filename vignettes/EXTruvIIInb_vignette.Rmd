...
p1 <- ggplot(bio.lisi, aes(x=Data, y=log(Bio_LISI), fill=Data)) + 
  ggtitle("The distribution of biological LISI scores across cells\nfor raw and corrected data") +
...
p2 <- ggplot(bat.lisi, aes(x=Cell_Type, y=log(Bat_LISI), fill=Data)) + 
  ggtitle("The distribution of batch LISI scores across cells for raw and corrected data") +
  labs(x = "Cell Type",
