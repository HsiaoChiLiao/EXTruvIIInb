#' This is an internal function of RUV-III-NB package - parallelized version of \code{edgeR::estimateDisp} function, see \code{help("estimateDisp")} for details.
#' 
#' @param y ...
#' @param design ...
#' @param group ...
...
#' @import edgeR
#' @import foreach
#' @importFrom stats model.matrix optimize
#'
estimateDisp.par <-
function (y, design = NULL, group = NULL, lib.size = NULL, offset = NULL, 
                              ...
                              grid.range = c(-10, 10), robust = FALSE, winsor.tail.p = c(0.05, 0.1), 
                              tol = 1e-06, weights = NULL, BPPARAM=BPPARAM, ...){
